...
const VaishnaviSections = () => {
  ...
  const renderContent = () => {
      ...
      return (
        <div className="space-y-16">
          ...
          <div className="space-y-8">
            <h2 className="text-4xl font-bold text-gray-900 mb-8">Future-Ready Location</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                />
                <p className="text-gray-800 text-lg">Top schools, hospitals & malls within minutes</p>
              </div>
              <div className="flex items-start space-x-4">
                <img
                  ...
                  className="w-10 h-10 flex-shrink-0"
                />
                <p className="text-gray-800 text-lg">Quick access to JP Nagar, Jayanagar & Central Bengaluru</p>
              </div>
              <div className="flex items-start space-x-4">
                <img
                  ...
                  className="w-10 h-10 flex-shrink-0"
                />
                <p className="text-gray-800 text-lg">JP Nagar Metro Station</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-8">The Design Revolution</h2>
            ...
            <div className="bg-white rounded-lg overflow-hidden">
              ...
              />
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Advanced Aluminium Formwork Construction</h3>
    ...
    if (activeTab === 2) {
      return (
        <div className="space-y-16">
          {/* Standout Features */}
          <div className="space-y-8">
            <h2 className="text-4xl font-bold text-gray-900 mb-8">Standout Features</h2>
          ...
          <div className="space-y-8">
            <h2 className="text-4xl font-bold text-gray-900">Purposeful Amenities</h2>
    ...
    if (activeTab === 3 && activeSubtab === 'WALK THROUGH MASTERPLAN') {
      return (
        <div className="space-y-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-8">Walk Through Masterplan</h2>
    ...
    if (activeTab === 3 && activeSubtab === 'FLOOR PLANS') {
      return (
        <div className="space-y-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-8">Floor Plans</h2>
          <div className="bg-gray-50 p-8 rounded-lg text-center">
            <p className="text-gray-600 text-lg mb-4">
    ...
    if (activeTab === 3 && activeSubtab === 'GALLERY') {
      return (
        <div className="space-y-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-8">Gallery</h2>
  ...
  return (
    <section className="bg-gray-100 min-h-screen py-12">
      <div className="flex max-w-7xl mx-auto shadow-2xl rounded-lg overflow-hidden">
        {/* Vertical Tab Navigation */}
        <div className="w-24 flex-shrink-0 bg-gradient-to-b from-cyan-100 via-cyan-200 to-cyan-300">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              onClick={() => {
              ...
              className={`w-full h-64 flex flex-col items-center justify-center border-b border-cyan-400 transition-all ${
                activeTab === tab.id
                  ? 'bg-cyan-400 text-gray-900'
                  : 'bg-transparent text-gray-600 hover:bg-cyan-300'
              }`}
            >
              <span className="text-3xl font-bold mb-4">{tab.number}</span>
              <span
                className="text-xs font-medium tracking-widest whitespace-nowrap"
                style={{
                  writingMode: 'vertical-rl',
                  transform: 'rotate(180deg)',
                  textOrientation: 'mixed'
        ...
        <div className="flex-1 bg-white">
          ...
          <div className="bg-gray-50 border-b border-gray-200 px-8 py-6">
            <div className="flex items-center justify-between">
              <h3 className="text-2xl font-bold text-cyan-600">{currentTab?.subtitle}</h3>
          ...
          {/* Content */}
          <div className="px-8 py-12 max-h-[800px] overflow-y-auto">
