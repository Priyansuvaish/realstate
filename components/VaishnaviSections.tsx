        ...
        <div className="space-y-8 md:space-y-16">
          ...
          <div className="space-y-4 md:space-y-8">
            ...
            <div className="w-full h-48 md:h-80 lg:h-96 bg-gray-200 rounded-lg overflow-hidden mb-4 md:mb-8">
              <iframe
                src="https://maps.google.com/maps?q=Vaishnavi+AT-One+Krishna+Brindavan,+WH69%2BHGQ,+Umarbagh+Layout,+Banashankari+Temple+Ward,+Bengaluru,+Karnataka+560111&t=&z=15&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Vaishnavi AT-One Krishna Brindavan Location"
              />
            </div>
